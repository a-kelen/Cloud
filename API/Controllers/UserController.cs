...
namespace API.Controllers
{
    ...
    public class UserController : BaseConttoller
    {
        ...
        public UserController(DataContext dataContext,  UserManager<User> userManager, SignInManager<User> signInManager, IMapper mapper, iJWTGenerator _iJWTGenerator)
        {
            this.db = dataContext;
            this.mapper = mapper;
